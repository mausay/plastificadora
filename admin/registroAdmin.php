	  ...
	  <menu>
			...
			<li><a href="../admin.php">Ultimas Compras</a></li>
	    		<li><a href="./agregarproducto.php" >Agregar</a></li>
                        ...
                        <li><a href="#" class="selected" >Nuevo Admin</a></li>
	    		<li><a href="../login/cerrar.php">Salir</a></li>
            
	  </menu>
	</nav>
            <center><h3>Nuevo Administrador</h3></center>
            <form name="datos"  id="formulario" method="POST" action="../admin/controlRegistroAdmin.php" onsubmit="return validar(this);" >
